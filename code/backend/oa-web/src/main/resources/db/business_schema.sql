-- Canonical persistent business tables for the current oa-web startup module.
-- Permission seed data is intentionally not included
...
CREATE TABLE IF NOT EXISTS hr_perf_goal (
  ...
  emp_id BIGINT NOT NULL,
  goal_content VARCHAR(1000) NOT NULL,
...
CREATE TABLE IF NOT EXISTS hr_perf_eval (
  ...
  evaluator_id BIGINT,
  eval_type VARCHAR(20) NOT NULL DEFAULT 'SELF',
  score DECIMAL(8,2) NOT NULL DEFAULT 0.00,
...
CREATE TABLE IF NOT EXISTS hr_train_enroll (
  ...
  attendance VARCHAR(16) NOT NULL DEFAULT 'PENDING',
  sign_time DATETIME,
  score DECIMAL(8,2),
  credit_granted DECIMAL(8,2),
  del_flag CHAR(1) NOT NULL DEFAULT '0',
  create_by VARCHAR(64),
  create_time DATETIME NOT NULL DEFAULT CURRENT_TIMESTAMP,
  update_by VARCHAR(64),
