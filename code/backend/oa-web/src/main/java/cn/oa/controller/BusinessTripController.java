...
public class BusinessTripController {
    ...
    public R<PageResult<OaBusinessTrip>> page(@RequestParam int pageNum,
        ...
        IPage<OaBusinessTrip> page = businessTripService.pageList(PageParamUtil.pageNum(pageNum), PageParamUtil.pageSize(pageSize), queryScopeService.resolveEmpId(request, empId), status);
