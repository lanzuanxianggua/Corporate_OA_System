<template>
  <div>
    ...
    <el-card>
      ...
      <el-table :data="todayData ? [todayData] : []" stripe>
      ...
      <el-empty v-if="!todayData" description="今日暂无打卡记录" />
    </el-card>
  </div>
</template>
...
import { getTodayAttendance, clockIn as clockInApi, clockOut as clockOutApi } from "@/api/attendance";
