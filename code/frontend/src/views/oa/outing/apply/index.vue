    ...
    <el-row :gutter="20" class="h-full">
        ...
        <el-card shadow="never" class="h-full">
          <template #header>
            <div class="flex items-center justify-between">
              <span class="text-base font-semibold text-[var(--oa-text)]">我的外出记录</span>
      ...
      <el-col :xs="24" :md="14">
        <el-card shadow="never">
          <template #header>
            <span class="text-base font-semibold text-[var(--oa-text)]">提交外出申请</span>
          </template>
...
import { formatTime, formatStatusText, formatStatusTagType, isPendingStatus } from "@/utils/format";
